...
public class TableOfDataTemp2 extends AppCompatActivity {
    ...
    public void loadData() throws IOException, JSONException {
        ...
        if (extras != null) {
            final String categories = extras.getString("category");
            System.out.println("categories "+categories);
            json = new JSONObject(categories);
            String subcat=json.getString("category");
            System.out.println("subcat "+subcat);
            RequestHandler requestHandler = new RequestHandler();

            //creating request parameters
            HashMap<String, String> params = new HashMap<>();
            params.put("category_id", subcat);

            params.put("type", "subcategory");
            ...
            /*if (i > -1) {
                ...
                layCustomer.addView(tv3b);
                    ...
                    if (i > -1) {
                        ...
                        System.out.println("button.setId(categories_id) "+categories_id);
